  ...
  const handleExport = async () => {
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_URL}/expenses/export?format=csv`,
        {
          credentials: "include",
        }
      );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        ...
        <div className="flex space-x-1 sm:space-x-2 mb-4 sm:mb-6 bg-white p-1.5 sm:p-2 rounded-lg shadow-sm overflow-x-auto scrollbar-hide">
          <button
            ...
            className={`flex-1 min-w-[80px] sm:min-w-[100px] py-2 px-2 sm:px-4 rounded-lg font-medium transition text-xs sm:text-sm whitespace-nowrap ${
              view === "dashboard"
